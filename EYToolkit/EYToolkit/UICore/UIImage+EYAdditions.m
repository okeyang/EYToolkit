...
EY_FIX_CATEGORY_BUG(UIImageEYAdditions)

@implementation UIImage (EYAdditions)
 ...
 */
- (UIImage*)imageWithTransformWidth:(CGFloat)width height:(CGFloat)height rotate:(BOOL)rotate {
    CGFloat destW = width;
